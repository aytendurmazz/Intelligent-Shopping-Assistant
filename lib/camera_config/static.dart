...
class _StaticImageState extends State<StaticImage> {
  ...
  loadTfModel() async {
    await Tflite.loadModel(
      model: "assets/module/aytengelenson.tflite",
      labels: "assets/module/aytengelenson.txt",
    );
  }
    ...
    return _recognitions.map((re) {
      return Container(
        child: Positioned(
            ...
            child: ((re["confidenceInClass"] > 0.5))
                ? Container(
